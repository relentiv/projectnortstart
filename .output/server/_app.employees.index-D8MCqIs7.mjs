...
import { s as settingsApi, l as listEmployees, A as downloadCsv, B as employeesToCsv, c as cn, C as archiveEmployees } from "./_ssr/router-CPP24NZe.mjs";
...
import { a4 as FunnelX, A as ArrowUpRight } from "./_libs/lucide-react.mjs";
    ...
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-7 h-7 rounded-full bg-[#FAFAF9] text-[#8E8E8E] border border-[#F2F2F0] group-hover:bg-[#0A0A0A] group-hover:text-white group-hover:border-[#0A0A0A] transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-3.5 h-3.5 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center pt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-[11px] font-semibold uppercase tracking-[0.1em] text-[#8E8E8E] truncate w-full", children: departmentName ?? "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-3 border-t border-[#F2F2F0] flex items-center justify-between text-[11px] text-[#8E8E8E]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium", children: [
            "Code: ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#0A0A0A] font-semibold", children: employee.employeeCode })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-orange-600 group-hover:underline inline-flex items-center gap-0.5", children: "View Profile" })
        ] })
      ]
    }
  );
