...
import { l as listEmployees, z as objectiveDisplayProgress, S as Spinner, y as performanceApi } from "./_ssr/router-LFebWAoY.mjs";
...
import { O as ObjectiveCard } from "./_ssr/ObjectiveCard--wTqC3X_.mjs";
...
import { b as Target, a2 as Plus, I as TrendingUp, w as CircleCheck, T as TriangleAlert, a3 as Funnel } from "./_libs/lucide-react.mjs";
...
import "./_ssr/Card-C9YFlUub.mjs";
import "./_ssr/GoalProgressRing-CMq4AJ3m.mjs";
import "./_ssr/GoalStatusBadge-CARSvdCA.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "rounded-3xl border border-[#E5E5E3] bg-white p-6 sm:p-7 shadow-xs relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-extrabold uppercase tracking-wider bg-[#0A0A0A] text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-3 h-3 text-orange-400" }),
          "OKR Tracker"
        ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: () => setOpen(true), className: "gap-2 bg-[#0A0A0A] hover:bg-neutral-800 text-white font-bold px-5 rounded-xl shadow-2xs", children: [
