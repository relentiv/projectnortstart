...
const sizeMap = { sm: 28, md: 40, lg: 64, xl: 80 };
const statusColor = {
...
function EmployeeAvatar({ employee, size = "md", showStatus, status, className }) {
  ...
  const s = status ? statusColor[status] : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: cn("relative inline-flex shrink-0 select-none", className), style: { width: px, height: px }, children: [
    employee.avatarUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
    ...
    showStatus && status && s && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute bottom-0 right-0 flex items-center justify-center", children: [
      status === "active" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
