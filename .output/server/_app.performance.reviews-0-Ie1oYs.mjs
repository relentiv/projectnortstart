...
import { l as listEmployees, S as Spinner, y as performanceApi } from "./_ssr/router-LFebWAoY.mjs";
...
import { R as ReviewFormRenderer } from "./_ssr/ReviewFormRenderer-B-9kEYpV.mjs";
import { L as Link } from "./_libs/tanstack__react-router.mjs";
import { C as Card } from "./_ssr/Card-C9YFlUub.mjs";
import { I as InfoTooltip } from "./_ssr/InfoTooltip-DnIqtm1w.mjs";
...
import { G as FileText, C as Clock, U as Users, J as Award, a0 as Save, a1 as Send } from "./_libs/lucide-react.mjs";
...
import "./_ssr/RatingInput-BQ5wPmzA.mjs";
import "./_ssr/GoalProgressRing-CMq4AJ3m.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "rounded-3xl border border-[#E5E5E3] bg-white p-6 sm:p-7 shadow-xs relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-extrabold uppercase tracking-wider bg-[#0A0A0A] text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3 h-3 text-orange-400" }),
      ...
      activeCycle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ReviewCycleBadge, { status: activeCycle.status }) })
    ] }),
