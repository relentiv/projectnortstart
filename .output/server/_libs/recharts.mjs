...
import { i as isString, a as isNumber$1, b as isNan, g as get, c as isNil, d as isObject, e as isFunction, u as upperFirst, f as uniqBy, s as sortBy, t as throttle, h as flatMap, m as min, j as max, k as isEqual, l as last, n as isPlainObject, o as isBoolean, r as range, p as every, q as mapValues, v as memoize, w as some } from "./lodash.mjs";
...
var adaptEventsOfChild = function adaptEventsOfChild2(props, data, index) {
  if (!isObject(props) || _typeof$B(props) !== "object") {
    return null;
  }
  var out = null;
...
var Symbols = function Symbols2(_ref) {
  ...
  var props = _objectSpread$u(_objectSpread$u({}, rest), {}, {
    type,
    size,
    sizeType
  });
    ...
    value: (
      ...
      function renderIcon(data) {
        ...
        if (/* @__PURE__ */ React.isValidElement(data.legendIcon)) {
          var iconProps = _objectSpread$t({}, data);
  ...
  return _createClass$f(Legend2, [{
    ...
    value: function getBBoxSnapshot() {
      if (this.lastBoundingBox.width >= 0 && this.lastBoundingBox.height >= 0) {
        return _objectSpread$s({}, this.lastBoundingBox);
      }
      return {
        width: 0,
        height: 0
    ...
    value: function render() {
      ...
      }, renderContent$1(content, _objectSpread$s(_objectSpread$s({}, this.props), {}, {
    ...
    value: function getWithHeight(item, chartWidth) {
      var _this$defaultProps$it = _objectSpread$s(_objectSpread$s({}, this.defaultProps), item.props), layout = _this$defaultProps$it.layout;
...
var TooltipBoundingBox = /* @__PURE__ */ (function(_PureComponent) {
  ...
  return _createClass$e(TooltipBoundingBox2, [{
    ...
    value: function render() {
      ...
      var outerStyle = _objectSpread$q(_objectSpread$q({
  ...
  var chartContent = reactExports.useMemo(function() {
    ...
    return React.Children.map(children, function(child) {
      if (/* @__PURE__ */ React.isValidElement(child)) {
        return /* @__PURE__ */ reactExports.cloneElement(child, _objectSpread$o({
...
function removeInvalidKeys(obj) {
  var copyObj = _objectSpread$n({}, obj);
...
var getStringSize = function getStringSize2(text) {
  ...
  try {
    ...
    var measurementSpanStyle = _objectSpread$n(_objectSpread$n({}, SPAN_STYLE), copyStyle);
...
var getLegendProps = function getLegendProps2(_ref) {
  ...
  var legendProps = legendDefaultProps !== void 0 ? _objectSpread$m(_objectSpread$m({}, legendDefaultProps), legendItem.props) : {};
  var legendData;
  if (legendItem.props && legendItem.props.payload) {
    ...
    legendData = (formattedGraphicalItems || []).map(function(_ref3) {
      ...
      var itemProps = itemDefaultProps !== void 0 ? _objectSpread$m(_objectSpread$m({}, itemDefaultProps), item.props) : {};
  ...
  return _objectSpread$m(_objectSpread$m(_objectSpread$m({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
    payload: legendData,
    item: legendItem
  });
};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem2(item) {
  ...
  var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread$l(_objectSpread$l({}, item.type.defaultProps), item.props) : item.props;
  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        ...
        var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread$l(_objectSpread$l({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
...
var appendOffsetOfLegend = function appendOffsetOfLegend2(offset, _unused, props, legendBox) {
  ...
  if (legendProps) {
    ...
    if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) {
      return _objectSpread$l(_objectSpread$l({}, offset), {}, _defineProperty$o({}, align, offset[align] + (boxWidth || 0)));
    }
    if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) {
      return _objectSpread$l(_objectSpread$l({}, offset), {}, _defineProperty$o({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
    }
  }
  return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId2(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
  ...
  var stackGroups = items.reduce(function(result, item) {
    var _item$type2;
    var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread$l(_objectSpread$l({}, item.type.defaultProps), item.props) : item.props;
    ...
    return _objectSpread$l(_objectSpread$l({}, result), {}, _defineProperty$o({}, axisId, parentGroup));
  ...
  return Object.keys(stackGroups).reduce(function(result, axisId) {
    ...
    if (group.hasStack) {
      ...
      group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
        ...
        return _objectSpread$l(_objectSpread$l({}, res), {}, _defineProperty$o({}, stackId, {
          numericAxisId,
          cateAxisId,
          items: g.items,
    ...
    return _objectSpread$l(_objectSpread$l({}, result), {}, _defineProperty$o({}, axisId, group));
...
var getStackedDataOfItem = function getStackedDataOfItem2(item, stackGroups) {
  var _item$type3;
  var defaultedProps = (_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread$l(_objectSpread$l({}, item.type.defaultProps), item.props) : item.props;
...
var getTooltipItem = function getTooltipItem2(graphicalItem, payload) {
  var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread$l(_objectSpread$l({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
  ...
  return _objectSpread$l(_objectSpread$l({}, filterProps(graphicalItem, false)), {}, {
    dataKey,
    unit,
    formatter,
    name: name || dataKey,
...
var inRangeOfSector = function inRangeOfSector2(_ref5, sector) {
  ...
  if (inRange) {
    return _objectSpread$k(_objectSpread$k({}, sector), {}, {
      radius,
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel2(props) {
  ...
  if (position === "top") {
    ...
    return _objectSpread$j(_objectSpread$j({}, attrs), parentViewBox ? {
  ...
  if (position === "bottom") {
    ...
    return _objectSpread$j(_objectSpread$j({}, _attrs), parentViewBox ? {
  ...
  if (position === "left") {
    ...
    return _objectSpread$j(_objectSpread$j({}, _attrs2), parentViewBox ? {
  ...
  if (position === "right") {
    ...
    return _objectSpread$j(_objectSpread$j({}, _attrs3), parentViewBox ? {
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(Layer, {
    ...
    return /* @__PURE__ */ React.createElement(Label, _extends$g({}, filterProps(entry, true), others, idProps, {
      ...
      value,
      textBreakAll,
      viewBox: Label.parseViewBox(isNil(clockWise) ? entry : _objectSpread$i(_objectSpread$i({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
var Sector = function Sector2(sectorProps) {
  var props = _objectSpread$h(_objectSpread$h({}, defaultProps$2), sectorProps);
