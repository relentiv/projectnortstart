...
import { S as Spinner, b as formatMinutes, a as attendanceApi, E as pad2$1, g as formatClock, D as dateKey$1, h as getCurrentPosition } from "./_ssr/router-LFebWAoY.mjs";
...
import { d as Sparkles, o as Calendar, A as ArrowUpRight, x as UserCheck, N as Timer, J as Award, C as Clock, t as Play, u as Square, v as Coffee, w as CircleCheck, p as ShieldCheck, O as MapPin, Q as ChevronLeft, V as ChevronRight } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-6 sm:space-y-7 pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 sm:p-7 rounded-3xl bg-gradient-to-r from-neutral-900 via-neutral-900 to-neutral-800 text-white shadow-md relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-semibold bg-white/10 text-neutral-200 border border-white/15 backdrop-blur-md", children: [
