...
import { l as listEmployees, y as performanceApi, z as objectiveDisplayProgress, S as Spinner } from "./_ssr/router-LFebWAoY.mjs";
...
import { G as GoalStatusBadge } from "./_ssr/GoalStatusBadge-CARSvdCA.mjs";
import { G as GoalProgressRing } from "./_ssr/GoalProgressRing-CMq4AJ3m.mjs";
import { R as ReviewCycleBadge } from "./_ssr/ReviewCycleBadge-XW-PS9lg.mjs";
import { a as authStore } from "./_ssr/auth-Dq95Bc2W.mjs";
import { d as Sparkles, b as Target, A as ArrowUpRight, G as FileText, h as ChartColumn, I as TrendingUp, C as Clock, J as Award, K as Star, p as ShieldCheck } from "./_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-6 sm:space-y-7 pb-12", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "rounded-3xl border border-[#E5E5E3] bg-white p-6 sm:p-7 shadow-xs relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-extrabold uppercase tracking-wider bg-[#0A0A0A] text-white", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-[#E5E5E3] bg-white p-6 sm:p-7 shadow-xs relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 mb-4 border-b border-[#F2F2F0]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-extrabold uppercase tracking-wider bg-orange-50 text-orange-700 border border-orange-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3 h-3 text-orange-500" }),
            "Active Review Cycle"
          ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl bg-[#111111] text-white p-6 sm:p-7 border border-[#222222] shadow-xl relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex items-center justify-between pb-4 mb-4 border-b border-[#262626]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 text-orange-400 fill-orange-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[16px] sm:text-[18px] font-bold text-white tracking-tight", children: "Recent Feedback & Score" })
            ] }),
